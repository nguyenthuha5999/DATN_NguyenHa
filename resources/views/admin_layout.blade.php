    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Nguyễn Thu Hà</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Thư mục</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Cài đặt</a></li>
                <li><a href="{{url('admin')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('them_sanpham')}}">Thêm sản phẩm</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('them_loaisanpham')}}">Thêm loại sản phẩm</a></li>
						<li><a href="{{url('loaisanpham')}}">Loại Sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                <a href="{{url('khachhang')}}">
                    ...
                    <ul class="sub">
						<li><a href="{{url('them_khachhang')}}">Thêm khách hàng</a></li>
						<li><a href="{{url('khachhang')}}">Khách hàng</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{url('them_hoadonban')}}">Thêm hóa đơn bán</a></li>
						<li><a href="{{url('hoadonban')}}">hóa đơn bán</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{url('chitiethdb')}}">
                        <i class="fa fa-book"></i>
                        <span>Quản lý chi tiết hóa đơn bán</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{url('them_chitiethdb')}}">Thêm chi tiết hóa đơn bán</a></li>
						<li><a href="{{url('chitiethdb')}}">Chi tiết hóa đơn bán</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{url('users')}}">
                    ...
                    <ul class="sub">
						<li><a href="{{url('them_users')}}">Thêm users</a></li>
